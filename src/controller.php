...
class controller_base {
	...
	protected function get_all($args = array(), $limit = 0, $offset = 0, &$count = null, $resource = false) {
		return $this->_database->get_all($resource ?: $this->_resource, $args, $limit, $offset, $count);
	}
